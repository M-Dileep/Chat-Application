...
function onConnected() {
    ...
    stompClient.subscribe('/user/queue/private', onMessageReceived); // Subscribe to private messages
...
function onMessageReceived(payload) {
    ...
    if (message.privateMessage) {
        // Handle private message UI logic
        message.content = message.sender + ' (Private): ' + message.content;
    } else {
        // Handle regular message UI logic
...
function sendMessage(event) {
    ...
    if (messageContent && stompClient) {
        ...
        // Check if a recipient is selected (for private messages)
        if (selectedRecipient) {
            chatMessage.recipient = selectedRecipient;
            chatMessage.privateMessage = true;
        }
